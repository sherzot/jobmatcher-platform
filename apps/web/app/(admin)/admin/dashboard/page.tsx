...
export default function AdminDashboardPage() {
  ...
  const pendingCompanies = MOCK_ADMIN_COMPANIES.filter(
        ...
        <div className="mb-6 flex flex-wrap gap-3">
          {PLATFORM_STATS.pendingVerifications > 0 && (
            ...
            >
              ...
              <span>
                <strong>{PLATFORM_STATS.pendingVerifications}社</strong>
                が企業認証待ちです →
              </span>
            </Link>
          )}
          {PLATFORM_STATS.flaggedAccounts > 0 && (
            ...
            >
              ...
              <span>
                <strong>{PLATFORM_STATS.flaggedAccounts}件</strong>
                のフラグ付きアカウント →
              </span>
            </Link>
          )}
        ...
        <div className="lg:col-span-2 rounded-xl border border-gray-200 bg-white">
          ...
          <div className="divide-y divide-gray-50">
            {topAgents.map((agent, idx) => (
              ...
              >
                <span className="w-5 shrink-0 text-sm font-bold text-gray-300">
                  #{idx + 1}
                </span>
                <div
                  className={cn(
                  ...
                  <div key={c.id} className="flex items-center gap-3 px-5 py-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-gray-400">
                        {c.assignedAgentName} · {c.registeredAt}
                      </p>
                    </div>
                    <span
                      className={cn(
                        "shrink-0 rounded-full px-2 py-0.5 text-xs font-medium",
                        VERIFICATION_COLORS[c.verificationStatus],
                      )}
                    >
