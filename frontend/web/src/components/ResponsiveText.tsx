...
export function ResponsiveHeading4({
  children,
  className = "",
}: {
  children: React.ReactNode;
...
export function ResponsiveSmall({
  children,
  className = "",
}: {
  children: React.ReactNode;
...
export function ResponsiveTextCenter({
  children,
  className = "",
}: {
  children: React.ReactNode;
...
export function ResponsiveTextRight({
  children,
  className = "",
}: {
  children: React.ReactNode;
...
export function ResponsiveTextMuted({
  children,
  className = "",
}: {
  children: React.ReactNode;
...
export function ResponsiveTextSecondary({
  children,
  className = "",
}: {
  children: React.ReactNode;
